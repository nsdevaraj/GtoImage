...
public class HttpFileUpload implements Runnable {
	...
	HttpFileUpload(String urlString, String vTitle, String vDesc, Context contx) {
		try {
			mcont = contx;
	...
	private void sendMessage(String msg) {
		...
		LocalBroadcastManager.getInstance(mcont).sendBroadcast(intent);
	}
